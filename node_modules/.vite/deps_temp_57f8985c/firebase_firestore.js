import {
  ...
  isSafari,
  registerVersion
} from "./chunk-JBABPZVY.js";
import "./chunk-5WRI5ZAA.js";

// client/node_modules/@firebase/webchannel-wrapper/dist/esm/index.esm2017.js
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    ...
    this.Ii = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.C()) throw new FirestoreError(D2.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.O_.Ue(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.O_.Ye(t) : e.O_.ze(t), !n.isEqual(SnapshotVersion.min())) try {
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e2 of t) {
    ...
    if (i) {
      for (const t3 of i.listeners) t3.U_(e2) && (r2 = true);
      i.q_ = e2;
    }
  }
...
async function __PRIVATE_syncEngineUnlisten(e, t) {
  ...
  if (i.length > 1) return n.ga.set(r2.targetId, i.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void n.fa.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r2 of e.ga.get(t)) e.fa.delete(r2), n && e.ma.Ma(r2, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n) if (r2 instanceof __PRIVATE_AddedLimboDocument) e.Sa.addReference(r2.key, t), __PRIVATE_trackLimboChange(e, r2);
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  createSharedClientState(e) {
    ...
    if (!__PRIVATE_WebStorageSharedClientState.C(t)) throw new FirestoreError(D2.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Tu) throw 1 === e.Tu ? e.fu(`${this._methodName}() can only appear at the top level of your update data`) : e.fu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Tu)) throw t2.fu(`${e2._methodName}() can only be used with update() and set()`);
  ...
  if (
    ...
    if (t.settings.Au && 4 !== t.Tu) throw t.fu("Nested arrays are not supported");
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r2.isEqual(n)) throw t2.fu(`Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`);
      return {
