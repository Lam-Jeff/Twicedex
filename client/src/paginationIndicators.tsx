...
export const PaginationIndicator = ({ setCurrentPage, pages, currentPage, numberIndicatorsToDisplayMin, numberIndicatorsToDisplayMax, maxPageIndicatorsToDisplay }: PaginationIndicatorProps) => {
    ...
    return (
        <div className="pagination-box-indicators">
            <div className="pagination-box-indicators__info">
                <button >{`Page ${currentPage} of ${pages.length}`}</button>
            </div>
                    ...
                    if (object >= min && object <= max) {
                        return (
                            <li key={`page_${object}`}
                                ...
                                <button className={currentPage === object ? 'active' : ''}>{object}</button>
                            </li>)
                    }
                    else {
                        return (null)
